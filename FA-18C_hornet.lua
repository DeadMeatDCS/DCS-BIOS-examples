...
-- OFFLINE MODIFICATION BY DEADMEAT v1.0
...
definePotentiometer("RIGHT_LOUVER", 11, 3011, 506, {0, 1}, "Environment Control Louver", "Right Louver")
...
defineToggleSwitch("LAUNCH_BAR_SW", 5, 3008, 233, "Select Jettison Button", "Launch Bar")
defineToggleSwitch("HOOK_BYPASS_SW", 9, 3009, 239, "Select Jettison Button", "HOOK BYPASS Switch, FIELD/CARRIER")
...
defineToggleSwitch("APU_CONTROL_SW", 12, 3001, 375, "Auxiliary Power Unit Panel", "APU Control Switch, ON/OFF")
...
defineFloat("FLOOD_INT_LT", 461, {0, 1}, "Internal Lights", "Flood Lightning (light green)")
defineFloat("NVG_FLOOD_INT_LT", 462, {0, 1}, "Internal Lights", "Nvg Flood Lightning (light green)")
defineFloat("CHART_INT_LT", 463, {0, 1}, "Internal Lights", "Chart Lightning (light green)")
...
defineFloat("INSTR_INT_LT", 466, {0, 1}, "Internal Lights", "Instrument Lightning (light green)")
defineFloat("STBY_COMPASS_INT_LT", 467, {0, 1}, "Internal Lights", "Stby Compass Lightning (light green)")
defineFloat("IFEI_DISP_INT_LT", 468, {0, 1}, "Internal Lights", "IFEI Display Lightning (light green)")
defineFloat("IFEI_BTN_INT_LT", 469, {0, 1}, "Internal Lights", "IFEI Buttons Lightning (light green)")
defineIndicatorLight("CMSD_JET_SEL_L", 516, "Dispenser/EMC Panel", "ECM JETT JETT SEL Button Light (green)")
defineFloat("RWR_LT_BRIGHT", 520, {0, 1}, "RWR Control Indicator", "RWR Lights Brightness")
